...
class SerializationServiceV1 {
    ...
    registerDefaultSerializers() {
        ...
        this.registerSerializer('localDate', new DefaultSerializers_1.LocalDateSerializer());
        this.registerSerializer('localTime', new DefaultSerializers_1.LocalTimeSerializer());
        this.registerSerializer('localDateTime', new DefaultSerializers_1.LocalDateTimeSerializer());
        this.registerSerializer('offsetDateTime', new DefaultSerializers_1.OffsetDateTimeSerializer());
        ...
        this.registerSerializer('arrayList', new DefaultSerializers_1.ArrayListSerializer());
        this.registerSerializer('linkedList', new DefaultSerializers_1.LinkedListSerializer());
        this.registerSerializer('uuid', new DefaultSerializers_1.UuidSerializer());
        this.registerSerializer('bigDecimal', new DefaultSerializers_1.BigDecimalSerializer());
        this.registerSerializer('bigint', new DefaultSerializers_1.BigIntSerializer());
        this.registerSerializer('javaArray', new DefaultSerializers_1.JavaArraySerializer());
