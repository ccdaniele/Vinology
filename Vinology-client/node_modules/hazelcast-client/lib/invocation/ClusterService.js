...
class ClusterService {
    ...
    detectMembershipEvents(prevMembers, currentMembers, connectionRegistry) {
        ...
        deadMembers.forEach((member) => {
            ...
            const connection = connectionRegistry.getConnection(member.uuid);
            if (connection != null) {
    ...
    static createSnapshot(memberListVersion, memberInfos) {
