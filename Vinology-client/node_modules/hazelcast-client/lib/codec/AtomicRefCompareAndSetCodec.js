...
exports.AtomicRefCompareAndSetCodec = void 0;
...
// hex: 0x0A0200
const REQUEST_MESSAGE_TYPE = 655872;
// hex: 0x0A0201
...
/** @internal */
class AtomicRefCompareAndSetCodec {
    static encodeRequest(groupId, name, oldValue, newValue) {
        ...
        CodecUtil_1.CodecUtil.encodeNullable(clientMessage, oldValue, DataCodec_1.DataCodec.encode);
...
exports.AtomicRefCompareAndSetCodec = AtomicRefCompareAndSetCodec;
//# sourceMappingURL=AtomicRefCompareAndSetCodec.js.map