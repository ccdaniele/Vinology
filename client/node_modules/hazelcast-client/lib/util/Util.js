...
function getType(obj) {
    ...
    else if (core_1.UUID.isUUID(obj)) {
        return 'uuid';
    }
    else if (obj instanceof core_1.LocalDate) {
        return 'localDate';
    }
    else if (obj instanceof core_1.LocalTime) {
        return 'localTime';
    }
    else if (obj instanceof core_1.LocalDateTime) {
        return 'localDateTime';
    }
    else if (obj instanceof core_1.OffsetDateTime) {
        return 'offsetDateTime';
    }
    else if (obj instanceof core_1.BigDecimal) {
        return 'bigDecimal';
    }
    else {
        const t = typeof obj;
