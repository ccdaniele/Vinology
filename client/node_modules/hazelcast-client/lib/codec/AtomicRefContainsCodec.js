...
exports.AtomicRefContainsCodec = void 0;
...
// hex: 0x0A0300
const REQUEST_MESSAGE_TYPE = 656128;
// hex: 0x0A0301
...
/** @internal */
class AtomicRefContainsCodec {
    static encodeRequest(groupId, name, value) {
        ...
        CodecUtil_1.CodecUtil.encodeNullable(clientMessage, value, DataCodec_1.DataCodec.encode);
...
exports.AtomicRefContainsCodec = AtomicRefContainsCodec;
//# sourceMappingURL=AtomicRefContainsCodec.js.map